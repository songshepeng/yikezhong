package com.bwei.ssp.home_work.Fragment.Shouye.Search.database;
...
public class SearchContentDao extends AbstractDao<SearchContent, Long> {
    ...
    public static class Properties {
        ...
        public final static Property But_text = new Property(1, String.class, "but_text", false, "BUT_TEXT");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchContent entity) {
        ...
        String but_text = entity.getBut_text();
        if (but_text != null) {
            stmt.bindString(2, but_text);
        }
    }
    ...
    @Override
    protected final void attachEntity(SearchContent entity) {
    ...
    public SearchContent readEntity(Cursor cursor, int offset) {
        SearchContent entity = new SearchContent( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1) // but_text
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, SearchContent entity, int offset) {
        ...
        entity.setBut_text(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
     }
